              ...
              mkPool =
                ...
                }:
                {
                  ...
                  phpPackage = opts.php.pkg.buildEnv {
                    ...
                    extensions = if extensions == null then opts.php.extensions else extensions;
                  };
                  inherit phpEnv;
        ...
        contents = flatten (
          mapAttrsToList (
            ...
            if opts.enable then
              let
                mkPcovScripts =
                  if config.services.phpfpm.pools ? "${name}-pcov" then
                    [
                ...
                mkExcimerScripts =
                  if config.services.phpfpm.pools ? "${name}-excimer" then
                    let
